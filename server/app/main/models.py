...
class Image(models.Model):
    ...
    cropping_main = ImageRatioField('image', size_to_str(main_res))  # main full image
    cropping_small = ImageRatioField('image', size_to_str(small_res))  # small preview
    cropping_blur = ImageRatioField('image', size_to_str(blur_res))     # tiny blurred placeholder
